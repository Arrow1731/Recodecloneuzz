  ...
  return (
    <footer className="bg-[#003E3D] text-orange-50 p-6 md:p-12 lg:p-16 mt-[50px]">
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <nav className="flex flex-col gap-2 text-neutral-300">
              <a href="Home" className="hover:text-[#DEB67B] transition-colors">
                Asosiy
              </a>
              <a
                href="Catalog"
                className="hover:text-[#DEB67B] transition-colors"
              >
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col gap-3 text-neutral-300">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <path
                    d="M13.3333 3.1665H2.66667C1.93029 3.1665 1.33334 3.76346 1.33334 4.49984V12.4998C1.33334 13.2362 1.93029 13.8332 2.66667 13.8332H13.3333C14.0697 13.8332 14.6667 13.2362 14.6667 12.4998V4.49984C14.6667 3.76346 14.0697 3.1665 13.3333 3.1665Z"
                    stroke="currentColor"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M14.6667 5.1665L8.68667 8.9665C8.48085 9.09545 8.24288 9.16384 8 9.16384C7.75712 9.16384 7.51916 9.09545 7.31334 8.9665L1.33334 5.1665"
                    stroke="currentColor"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <span>
                  <a
                    href="mailto:farruxtemireshik.gmail.com"
                    target="_blank"
                    className="hover:text-[#DEB67B] transition-colors"
                  >
                    info@redore.uz
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <path
                    d="M13.3333 7.16683C13.3333 10.4955 9.64066 13.9622 8.40066 15.0328C8.28515 15.1197 8.14453 15.1667 8 15.1667C7.85547 15.1667 7.71485 15.1197 7.59933 15.0328C6.35933 13.9622 2.66666 10.4955 2.66666 7.16683C2.66666 5.75234 3.22857 4.39579 4.22876 3.39559C5.22896 2.3954 6.58551 1.8335 8 1.8335C9.41449 1.8335 10.771 2.3954 11.7712 3.39559C12.7714 4.39579 13.3333 5.75234 13.3333 7.16683Z"
                    stroke="currentColor"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <span>
                  <a
                    href="https://maps.app.goo.gl/qUKzVL9hbr7fQ7Xj8"
                    target="_blank"
                    className="hover:text-[#DEB67B] transition-colors"
                  >
                    Xorazm viloyati, Bog'ot tumani Ashxobod mahallasi, Sarbon
                    ko'chasi, 14 - uy
                  </a>
                </span>
              </div>
        ...
        <div className="flex flex-col items-center text-center text-neutral-500 text-sm">
          <span>
            © 2024 Redore. Barcha huquqlar himoyalangan. Xorazm viloyatida temir
            eshiklar ishlab chiqarish.
          </span>
        </div>
      </div>
    </footer>
