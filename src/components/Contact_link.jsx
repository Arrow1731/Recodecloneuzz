    ...
    <footer className="bg-[#003E3D] text-orange-50 p-6 md:p-12 lg:p-16 mt-[50px]">
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-neutral-400 text-sm leading-tight">
              Temir eshiklar ishlab chiqaruvchi etakchi<br />Xorazm viloyatida. Sifat,<br />2009 yildan beri ishonchlilik va xavfsizlik.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <nav className="flex flex-col gap-2 text-neutral-300">
              <a href="Home" className="hover:text-[#DEB67B] transition-colors">Asosiy</a>
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex flex-col gap-3 text-neutral-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <span><a href="mailto:info@redore.uz" target='_blank'className="hover:text-[#DEB67B] transition-colors">info@redore.uz</a></span>
              </div>
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <path d="M8 9.1665C9.10457 9.1665 10 8.27107 10 7.1665C10 6.06193 9.10457 5.1665 8 5.1665C6.89543 5.1665 6 6.06193 6 7.1665C6 8.27107 6.89543 9.1665 8 9.1665Z" stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
        ...
        <div className="flex flex-col items-center text-center text-neutral-500 text-sm">
          <span>© 2024 Redore. Barcha huquqlar himoyalangan. Xorazm viloyatida temir eshiklar ishlab chiqarish.</span>
        </div>
      </div>
    </footer>
  );
