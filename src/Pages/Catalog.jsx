    ...
    >
      ...
      <div className="mt-4">
        ...
        <button
          ...
          className="mt-3 w-full bg-gradient-to-r from-[#DEB67B] to-[#c79c60] hover:opacity-90 text-white font-semibold py-2 rounded-xl shadow-md transition-all duration-300"
        >
          Buyurtma berish
        </button>
      </div>
