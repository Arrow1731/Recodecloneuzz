...
export default class about extends Component {
  render() {
    const stats = [
      { value: "15+", label: "Yillik tajriba", icon: CalendarCheck },
      { value: "5000+", label: "Mamnun mijozlar", icon: Users },
      { value: "50+", label: "Professional mutaxassislar", icon: Briefcase },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[80px] items-center mb-[70px]">
            ...
            <div>
              ...
              <p className="text-neutral-600 leading-relaxed">
                Bizning kompaniyamiz 2009-yildan buyon eshik ishlab chiqarish va <br />
