...
const TELEGRAM_BOT_TOKEN = "8064248553:AAG738iEmbGLXj3SIktd3-L8ZTI5qZya1Yo";
      ...
      <div className="container mx-auto mt-24 mb-24 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-stone-50 rounded-xl shadow-lg border-2 border-[#DEB67B] p-8 flex flex-col items-center text-center">
            <div className="mb-4">
              <div className="w-12 h-12 flex items-center justify-center rounded-full border-4 border-[#DEB67B]">
                {/* Phone icon */}
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[#DEB67B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="bg-stone-50 rounded-xl shadow-lg p-8 flex flex-col items-center text-center">
            ...
            <p className="text-lg font-normal text-neutral-950 mb-1">
              <a href="mailto:info@redore.uz" target="_blank" rel="noreferrer">info@redore.uz</a>
            </p>
            <p className="text-lg font-normal text-neutral-950 mb-4">
              <a href="mailto:sales@redore.uz" target="_blank" rel="noreferrer">sales@redore.uz</a>
            </p>
          ...
          <div className="bg-stone-50 rounded-xl shadow-lg p-8 flex flex-col items-center text-center">
            ...
            <div className="h-6 mb-4"></div>
            <p className="text-lg font-normal text-neutral-950 mb-1">
              <a href="https://t.me/redore_doors" target="_blank" rel="noreferrer">@redore_doors</a>
            </p>
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Request Form Column */}
            <div>
              <div className="bg-stone-50 rounded-xl shadow-lg p-8 h-[520px]">
